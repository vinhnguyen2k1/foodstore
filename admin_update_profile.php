   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" placeholder="Tên tài khoản mới" required class="box">
            <span>email:</span>
            <input type="email" name="email" value="<?= $fetch_profile['email']; ?>" placeholder="Email mới" required class="box">
            <span>Hình ảnh:</span>
