...
<section class="user-accounts">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box" style="<?php if($fetch_users['id']){ echo 'display:block'; }; ?>">
         ...
         <a href="admin_all_users.php?delete=<?= $fetch_users['id']; ?>" onclick="return confirm('Xóa tài khoản này?');" class="delete-btn">Xóa</a>
      </div>
      <?php
      }
      ?>
