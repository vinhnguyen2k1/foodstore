...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         $message[] = 'Kích thước hình ảnh lớn';
      }else{
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" placeholder="Cập nhật tên tài khoản" required class="box">
            <span>Email:</span>
      ...
      <div class="flex-btn">
         ...
         <a href="index.php" class="option-btn">Trở lại</a>
      </div>
   </form>
