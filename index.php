...
if(isset($_POST['add_to_cart'])){
   ...
   if($check_cart_numbers->rowCount() > 0){
      $message[] = 'Đã tốn tại trong giỏ hàng';
   }else{
...
<div class="home-bg">
   <section class="home">
      ...
      <div class="content">
         <span>Thịt - Cá - Rau Củ Quả - Sạch - An Toàn</span>
         ...
         <a href="about.php" class="btn">Thông Tin Về Cửa Hàng</a>
      </div>
   </section>
...
<section class="home-category">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="category.php?category=Hoa quả" class="btn">Hoa quả</a>
      </div>
